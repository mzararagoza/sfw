...
(function($) {
	$(document).ready(function() {
		var backgroundPattern = "/assets/admin2/core/bg/paper.png";
		...
		var patterns = [
			{
				name: "Paper", 
				img: "/assets/admin2/core/bg/paper.png"
			}, {
				name: "Blueprint", 
				img: "/assets/admin2/core/bg/blueprint.png"
			}, {
				name: "Bricks", 
				img: "/assets/admin2/core/bg/bricks.png"
			}, {
				name: "Carbon", 
				img: "/assets/admin2/core/bg/carbon.png"
			}, {
				name: "Circuit", 
				img: "/assets/admin2/core/bg/circuit.png"
			}, {
				name: "Holes", 
				img: "/assets/admin2/core/bg/holes.png"
			}, {
				name: "Mozaic", 
				img: "/assets/admin2/core/bg/mozaic.png"
			}, {
				name: "Roof", 
				img: "/assets/admin2/core/bg/roof.png"
			}, {
				name: "Stripes", 
				img: "/assets/admin2/core/bg/stripes.png"
			}, {
				name: "Arches", 
				img: "/assets/admin2/core/bg/arches.png"
			}, {
				name: "Bright Squares", 
				img: "/assets/admin2/core/bg/bright_squares.png"
			}, {
				name: "Brushed Alu", 
				img: "/assets/admin2/core/bg/brushed_alu.png"
			}, {
				name: "Circles", 
				img: "/assets/admin2/core/bg/circles.png"
			}, {
				name: "Climpek", 
				img: "/assets/admin2/core/bg/climpek.png"
			}, {
				name: "Connect", 
				img: "/assets/admin2/core/bg/connect.png"
			}, {
				name: "Corrugation", 
				img: "/assets/admin2/core/bg/corrugation.png"
			}, {
				name: "Cubes", 
				img: "/assets/admin2/core/bg/cubes.png"
			}, {
				name: "Diagonal Noise", 
				img: "/assets/admin2/core/bg/diagonal-noise.png"
			}, {
				name: "Diagonal Striped Brick", 
				img: "/assets/admin2/core/bg/diagonal_striped_brick.png"
			}, {
				name: "Diamonds", 
				img: "/assets/admin2/core/bg/diamonds.png"
			}, {
				name: "Diamond Upholstery", 
				img: "/assets/admin2/core/bg/diamond_upholstery.png"
			}, {
				name: "Escheresque", 
				img: "/assets/admin2/core/bg/escheresque.png"
			}, {
				name: "Fabric Plaid", 
				img: "/assets/admin2/core/bg/fabric_plaid.png"
			}, {
				name: "Furley", 
				img: "/assets/admin2/core/bg/furley_bg.png"
			}, {
				name: "Gplaypattern", 
				img: "/assets/admin2/core/bg/gplaypattern.png"
			}, {
				name: "Gradient Squares", 
				img: "/assets/admin2/core/bg/gradient_squares.png"
			}, {
				name: "Grey", 
				img: "/assets/admin2/core/bg/grey.png"
			}, {
				name: "Grilled", 
				img: "/assets/admin2/core/bg/grilled.png"
			}, {
				name: "Hexellence", 
				img: "/assets/admin2/core/bg/hexellence.png"
			}, {
				name: "Lghtmesh", 
				img: "/assets/admin2/core/bg/lghtmesh.png"
			}, {
				name: "Light Alu", 
				img: "/assets/admin2/core/bg/light_alu.png"
			}, {
				name: "Light Checkered Tiles", 
				img: "/assets/admin2/core/bg/light_checkered_tiles.png"
			}, {
				name: "Light Honeycomb", 
				img: "/assets/admin2/core/bg/light_honeycomb.png"
			}, {
				name: "Littleknobs", 
				img: "/assets/admin2/core/bg/littleknobs.png"
			}, {
				name: "Nistri", 
				img: "/assets/admin2/core/bg/nistri.png"
			}, {
				name: "Noise Lines", 
				img: "/assets/admin2/core/bg/noise_lines.png"
			}, {
				name: "Noise Pattern", 
				img: "/assets/admin2/core/bg/noise_pattern_with_crosslines.png"
			}, {
				name: "Noisy Grid", 
				img: "/assets/admin2/core/bg/noisy_grid.png"
			}, {
				name: "Norwegian Rose", 
				img: "/assets/admin2/core/bg/norwegian_rose.png"
			}, {
				name: "Pineapplecut", 
				img: "/assets/admin2/core/bg/pineapplecut.png"
			}, {
				name: "Pinstripe", 
				img: "/assets/admin2/core/bg/pinstripe.png"
			}, {
				name: "Project Papper", 
				img: "/assets/admin2/core/bg/project_papper.png"
			}, {
				name: "Ravenna", 
				img: "/assets/admin2/core/bg/ravenna.png"
			}, {
				name: "Reticular Tissue", 
				img: "/assets/admin2/core/bg/reticular_tissue.png"
			}, {
				name: "Rockywall", 
				img: "/assets/admin2/core/bg/rockywall.png"
			}, {
				name: "Roughcloth", 
				img: "/assets/admin2/core/bg/roughcloth.png"
			}, {
				name: "Shattered", 
				img: "/assets/admin2/core/bg/shattered.png"
			}, {
				name: "Silver Scales", 
				img: "/assets/admin2/core/bg/silver_scales.png"
			}, {
				name: "Skelatal Weave", 
				img: "/assets/admin2/core/bg/skelatal_weave.png"
			}, {
				name: "Small Crackle Bright", 
				img: "/assets/admin2/core/bg/small-crackle-bright.png"
			}, {
				name: "Small Tiles", 
				img: "/assets/admin2/core/bg/small_tiles.png"
			}, {
				name: "Square", 
				img: "/assets/admin2/core/bg/square_bg.png"
			}, {
				name: "Struckaxiom", 
				img: "/assets/admin2/core/bg/struckaxiom.png"
			}, {
				name: "Subtle Stripes", 
				img: "/assets/admin2/core/bg/subtle_stripes.png"
			}, {
				name: "Vichy", 
				img: "/assets/admin2/core/bg/vichy.png"
			}, {
				name: "Washi", 
				img: "/assets/admin2/core/bg/washi.png"
			}, {
				name: "Wavecut", 
				img: "/assets/admin2/core/bg/wavecut.png"
			}, {
				name: "Weave", 
				img: "/assets/admin2/core/bg/weave.png"
			}, {
				name: "Whitey", 
				img: "/assets/admin2/core/bg/whitey.png"
			}, {
				name: "White Brick Wall", 
				img: "/assets/admin2/core/bg/white_brick_wall.png"
			}, {
				name: "White Tiles", 
				img: "/assets/admin2/core/bg/white_tiles.png"
			}, {
				name: "Worn Dots", 
				img: "/assets/admin2/core/bg/worn_dots.png"
			}
		];
